...
- **IoT Systems** — sensor networks, real-time monitoring, ESP8266/ESP32
- **PCB Design** — schematics, layouts, Gerber-ready files in KiCad
- **Embedded Firmware** — C++ for microcontrollers and hardware interfaces
- **AI / ML** — Python-based models, computer vision, data pipelines
- **Web Projects** — HTML, TypeScript, full-stack interfaces
...
- 🔭 Building more IoT and embedded systems projects
- 📐 Deepening PCB design skills with KiCad
- 🤖 Exploring edge AI on embedded hardware
- 👀 Open to full-time roles in embedded systems, IoT, or hardware engineering
